  ...
  return (
    <>
      ...
      <KeyboardAvoidingView
        ...
        // iOS: JS-driven "padding" avoidance.
        // Android: native pan (softwareKeyboardLayoutMode=pan) already keeps
        // the composer visible. Keeping behavior="padding" on Android adds a
        // second JS lift on top of pan, so the input jumps too high on first
        // open and only settles after typing triggers a re-layout.
